...
package com.makeappssimple.abhimanyu.finance.manager.android.common.domain.use_case.transaction_for
...
internal class GetAllTransactionForValuesFlowUseCase(
    private val transactionForRepository: TransactionForRepository,
) {
    operator fun invoke(): Flow<ImmutableList<TransactionFor>> {
