...
package com.makeappssimple.abhimanyu.finance.manager.android.common.feature.transactions.view_transaction.screen
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.common.constants.TestTags.SCREEN_CONTENT_VIEW_TRANSACTION
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.common.constants.TestTags.SCREEN_VIEW_TRANSACTION
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.bottom_sheet.transactions.TransactionDeleteConfirmationBottomSheet
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.bottom_sheet.transactions.TransactionDeleteConfirmationBottomSheetEvent
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.view_transaction_section_header.ViewTransactionSectionHeader
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.view_transaction_section_header.ViewTransactionSectionHeaderData
import com.makeappssimple.abhimanyu.finance.manager.android.common.feature.transactions.view_transaction.bottom_sheet.ViewTransactionScreenBottomSheetType
import com.makeappssimple.abhimanyu.finance.manager.android.common.feature.transactions.view_transaction.event.ViewTransactionScreenUIEvent
import com.makeappssimple.abhimanyu.finance.manager.android.common.feature.transactions.view_transaction.state.ViewTransactionScreenUIState
        ...
        LazyColumn(
                ...
                item {
                    ViewTransactionSectionHeader(
                        data = ViewTransactionSectionHeaderData(
                            textStringResourceId = R.string.finance_manager_screen_view_transaction_original_transaction,
                        ),
                    )
                }
                item {
            ...
            if (uiState.refundTransactionsListItemData.isNotNull() &&
                ...
                item {
                    ViewTransactionSectionHeader(
                        data = ViewTransactionSectionHeaderData(
                            textStringResourceId = R.string.finance_manager_screen_view_transaction_refund_transactions,
                        )
                    )
                }
                items(
