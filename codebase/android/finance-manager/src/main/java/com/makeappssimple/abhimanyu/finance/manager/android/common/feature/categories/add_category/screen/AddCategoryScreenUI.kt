...
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.common.constants.TestTags.SCREEN_ADD_OR_EDIT_CATEGORY
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.common.constants.TestTags.SCREEN_CONTENT_ADD_OR_EDIT_CATEGORY
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.bottom_sheet.category.AddCategorySelectEmojiBottomSheet
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.emoji_circle.EmojiCircleSize
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.emoji_circle.MyEmojiCircle
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.emoji_circle.MyEmojiCircleData
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.emoji_circle.MyEmojiCircleEvent
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.selection_group.MyRadioGroup
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.selection_group.MyRadioGroupData
import com.makeappssimple.abhimanyu.finance.manager.android.common.core.ui.component.selection_group.MyRadioGroupEvent
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.feature.categories.add_category.event.AddCategoryScreenUIEvent
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.feature.categories.add_category.state.stringResourceId
import com.makeappssimple.abhimanyu.library.finance.manager.android.R
import kotlinx.coroutines.delay

@Composable
internal fun AddCategoryScreenUI(
    uiState: AddCategoryScreenUIState,
    ...
    MyScaffold(
        ...
        sheetContent = {
            when (uiState.screenBottomSheetType) {
                ...
                AddCategoryScreenBottomSheetType.SelectEmoji -> {
                    AddCategorySelectEmojiBottomSheet(
                        ...
                        updateEmoji = { updatedEmoji ->
                            handleUIEvent(
                                AddCategoryScreenUIEvent.OnEmojiUpdated(
                        ...
                        updateSearchText = { updatedSearchText ->
                            handleUIEvent(
                                AddCategoryScreenUIEvent.OnEmojiBottomSheetSearchTextUpdated(
        ...
        sheetShape = when (uiState.screenBottomSheetType) {
            ...
            is AddCategoryScreenBottomSheetType.SelectEmoji -> {
                ...
                handleEvent = { event ->
                    when (event) {
                        is MyRadioGroupEvent.OnSelectionChange -> {
                            handleUIEvent(
                                AddCategoryScreenUIEvent.OnSelectedTransactionTypeIndexUpdated(
                    ...
                    handleEvent = { event ->
                        when (event) {
                            is MyEmojiCircleEvent.OnClick -> {
                                handleUIEvent(AddCategoryScreenUIEvent.OnEmojiCircleClick)
                            }
                        }
                    },
                )
                    ...
                    handleEvent = { event ->
                        when (event) {
                            is MyOutlinedTextFieldEventV2.OnClickTrailingIcon -> {
                                handleUIEvent(AddCategoryScreenUIEvent.OnClearTitleButtonClick)
                            }
                        }
                    },
                )
                ...
                handleEvent = { event ->
                    when (event) {
                        is SaveButtonEvent.OnClick -> {
                            handleUIEvent(AddCategoryScreenUIEvent.OnCtaButtonClick)
                        }
                    }
                },
            )
