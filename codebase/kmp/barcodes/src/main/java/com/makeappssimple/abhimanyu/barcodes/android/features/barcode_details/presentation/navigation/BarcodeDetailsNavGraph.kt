...
import com.makeappssimple.abhimanyu.barcodes.android.resources.barcodes_screen_barcode_details_barcode_value_copied_toast_message
            ...
            showBarcodeValueCopiedToastMessage = { barcodeValue ->
                coroutineScope.launch {
                    Toast.makeText(
                        context,
                        getString(
                            Res.string.barcodes_screen_barcode_details_barcode_value_copied_toast_message,
                            barcodeValue,
                        ),
                        Toast.LENGTH_SHORT,
                    ).show()
