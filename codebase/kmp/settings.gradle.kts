...
include(":barcodes")
include(":core:clipboard-kit")
include(":core:coroutines")
include(":core:date-time")
include(":core:app-version-kit")
include(":core:build-config-kit")
include(":core:json-kit")
include(":core:kotlin")
include(":core:log-kit")
include(":core:uri-kit")
include(":cosmos-design-system:library")
