...
package com.makeappssimple.abhimanyu.cosmos.design.system.components.dropdown
...
@Composable
public fun CosmosDropdownMenuItem(
    modifier: Modifier = Modifier,
    leadingIconContentDescriptionStringResource: CosmosStringResource,
    stringResource: CosmosStringResource,
    onClick: () -> Unit,
    leadingIconResource: CosmosIconResource,
) {
    DropdownMenuItem(
        text = {
            CosmosText(
