...
internal fun AccountsDeleteConfirmationBottomSheet(
    ...
    MyConfirmationBottomSheet(
        data = MyConfirmationBottomSheetData(
            messageStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_accounts_bottom_sheet_delete_message)),
            negativeButtonTextStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_accounts_bottom_sheet_delete_negative_button_text)),
            positiveButtonTextStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_accounts_bottom_sheet_delete_positive_button_text)),
            titleStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_accounts_bottom_sheet_delete_title)),
        ),
        handleEvent = { event ->
            when (event) {
