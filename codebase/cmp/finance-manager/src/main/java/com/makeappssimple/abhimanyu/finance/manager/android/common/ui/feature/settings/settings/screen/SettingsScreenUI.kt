...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.spacer.CosmosNavigationBarsAndImeSpacer
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.presentation.constants.TestTags.SCREEN_CONTENT_SETTINGS
import com.makeappssimple.abhimanyu.finance.manager.android.common.presentation.constants.TestTags.SCREEN_SETTINGS
import com.makeappssimple.abhimanyu.finance.manager.android.common.presentation.feature.settings.settings.components.SettingsScreenListItemData
...
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemAppVersion
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemAppVersionData
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemContent
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemContentData
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemContentEvent
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemDivider
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemDividerData
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemHeader
import com.makeappssimple.abhimanyu.finance.manager.android.common.ui.ui.component.listitem.settings.SettingsListItemHeaderData
...
internal fun SettingsScreenUI(
    ...
    val restoreDataFailedSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_restore_data_failed)).text
    val cancelReminderFailedSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_cancel_reminder_failed)).text
    val cancelReminderSuccessfulSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_cancel_reminder_successful)).text
...
private fun SettingsScreenLoader(
    ...
    AnimatedVisibility(
        ...
        CosmosLinearProgressIndicator(
            modifier = Modifier
                .testTag(
                    tag = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_linear_progress_indicator_test_tag)).text,
                ),
        )
    }
}
            ...
            is SettingsListItemAppVersionData -> {
                SettingsListItemAppVersion(
                    data = SettingsListItemAppVersionData(
                        appVersionStringResource = listItemData.data.appVersionStringResource,
                    ),
                )
            }
    ...
    return persistentListOf(
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_categories)),
            ),
            handleEvent = { event ->
                when (event) {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_accounts)),
            ),
            handleEvent = { event ->
                when (event) {
                    is SettingsListItemContentEvent.OnClick -> {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_transaction_for)),
            ),
            handleEvent = { event ->
                when (event) {
                    is SettingsListItemContentEvent.OnClick -> {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_backup)),
            ),
            handleEvent = { event ->
                when (event) {
                    is SettingsListItemContentEvent.OnClick -> {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_restore)),
            ),
            handleEvent = { event ->
                when (event) {
                    is SettingsListItemContentEvent.OnClick -> {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_recalculate_total)),
            ),
            handleEvent = { event ->
                when (event) {
                    is SettingsListItemContentEvent.OnClick -> {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_reminder)),
            ),
            handleEvent = { event ->
                when (event) {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_credits)),
            ),
            handleEvent = { event ->
                when (event) {
                    is SettingsListItemContentEvent.OnClick -> {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemContentData(
                isEnabled = !uiState.isLoading,
                iconResource = CosmosIcons.TextSnippet,
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_settings_open_source_licenses)),
            ),
            handleEvent = { event ->
                when (event) {
                    is SettingsListItemContentEvent.OnClick -> {
        ...
        SettingsScreenListItemData(
            data = SettingsListItemAppVersionData(
                appVersionStringResource = CosmosStringResource.Text(
                    value = FinanceManagerStrings.get(
