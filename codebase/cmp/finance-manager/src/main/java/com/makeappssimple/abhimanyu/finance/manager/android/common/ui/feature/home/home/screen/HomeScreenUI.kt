...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.chart.compose_pie.data.PieChartData
import com.makeappssimple.abhimanyu.cosmos.design.system.components.chart.compose_pie.data.PieChartItemData
    ...
    MyScaffold(
        ...
        topBar = {
            MyTopAppBar(
                ...
                appBarActions = {
                    CosmosIconButton(
                        onClickLabelStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_home_appbar_settings)),
                        onClick = {
        ...
        floatingActionButton = {
            CosmosCircularFloatingActionButton(
                ...
                contentDescriptionStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_home_floating_action_button_content_description)),
                onClick = {
