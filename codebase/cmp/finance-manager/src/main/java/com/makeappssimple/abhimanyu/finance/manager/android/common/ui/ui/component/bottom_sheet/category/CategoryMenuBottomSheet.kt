    ...
    if (data.isEditVisible) {
        items.add(
            CategoryMenuBottomSheetItemData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_category_menu_edit)),
                onClick = onEditClick,
            )
        )
    }
    if (data.isSetAsDefaultVisible) {
        items.add(
            CategoryMenuBottomSheetItemData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_category_menu_set_as_default_category)),
    ...
    if (data.isDeleteVisible) {
        items.add(
            CategoryMenuBottomSheetItemData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_category_menu_delete)),
