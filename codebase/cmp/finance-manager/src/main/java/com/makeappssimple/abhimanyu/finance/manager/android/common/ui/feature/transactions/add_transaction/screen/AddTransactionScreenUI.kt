...
package com.makeappssimple.abhimanyu.finance.manager.android.common.ui.feature.transactions.add_transaction.screen
...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.date_picker.CosmosDatePicker
import com.makeappssimple.abhimanyu.cosmos.design.system.components.date_picker.CosmosDatePickerData
import com.makeappssimple.abhimanyu.cosmos.design.system.components.date_picker.CosmosDatePickerEvent
...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.save_button.CosmosSaveButtonEvent
import com.makeappssimple.abhimanyu.cosmos.design.system.components.spacer.CosmosNavigationBarsAndImeSpacer
import com.makeappssimple.abhimanyu.cosmos.design.system.components.spacer.CosmosVerticalSpacer
import com.makeappssimple.abhimanyu.cosmos.design.system.components.spacer.cosmosNavigationBarLandscapeSpacer
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text.CosmosText
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.CosmosReadOnlyTextFieldData
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.CosmosReadOnlyTextFieldEvent
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.MyOutlinedTextFieldDataV2
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.MyOutlinedTextFieldEventV2
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.MyOutlinedTextFieldV2
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.MyReadOnlyTextField
import com.makeappssimple.abhimanyu.cosmos.design.system.components.time_picker.CosmosTimePicker
import com.makeappssimple.abhimanyu.cosmos.design.system.components.time_picker.CosmosTimePickerData
import com.makeappssimple.abhimanyu.cosmos.design.system.components.time_picker.CosmosTimePickerEvent
...
internal fun AddTransactionScreenUI(
    ...
    val addTransactionFailedSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_add_or_edit_transaction_add_transaction_failed)).text
    val addTransactionSuccessfulSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_add_or_edit_transaction_add_transaction_successful)).text
        ...
        Column(
            ...
            CosmosSaveButton(
                ...
                data = CosmosSaveButtonData(
                    ...
                    isLoading = uiState.isLoading,
                    stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_add_transaction_floating_action_button_content_description)),
                ),
                handleEvent = { event ->
                    when (event) {
