        ...
        Column(
            ...
            CosmosSaveButton(
                ...
                data = CosmosSaveButtonData(
                    ...
                    isLoading = uiState.isLoading,
                    stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_edit_transaction_for_floating_action_button_content_description)),
                ),
                handleEvent = { event ->
                    when (event) {
