...
internal fun TransactionForListItem(
    ...
    Row(
        ...
        if (data.isMoreOptionsIconButtonVisible) {
            CosmosIconButton(
                onClickLabelStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_transaction_for_list_item_more_options_content_description)),
                onClick = {
