    ...
    if (isEditVisible) {
        items.add(
            AccountsMenuBottomSheetItemData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_accounts_menu_edit)),
                onClick = onEditClick,
            )
        )
    }
    if (isSetAsDefaultVisible) {
        items.add(
            AccountsMenuBottomSheetItemData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_accounts_menu_set_as_default_account)),
    ...
    if (isDeleteVisible) {
        items.add(
            AccountsMenuBottomSheetItemData(
                ...
                stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_accounts_menu_delete)),
