...
import com.makeappssimple.abhimanyu.core.kotlin.extensions.orEmpty
...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.tab_row.MyTabRow
...
internal fun CategoriesScreenUI(
    ...
    val setDefaultCategoryFailedSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_categories_set_default_category_failed)).text
    val setDefaultCategorySuccessfulSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_categories_set_default_category_successful)).text
    ...
    MyScaffold(
        ...
        floatingActionButton = {
            CosmosCircularFloatingActionButton(
                ...
                contentDescriptionStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_categories_floating_action_button_content_description)),
                onClick = {
                    handleUIEvent(
