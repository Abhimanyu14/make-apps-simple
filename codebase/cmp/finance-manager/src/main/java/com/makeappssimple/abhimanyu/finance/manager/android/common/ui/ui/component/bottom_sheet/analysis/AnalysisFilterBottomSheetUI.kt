    ...
    Column(
        ...
        Row(
            ...
            CosmosTextButton(
                ...
                CosmosText(
                    stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_analysis_filter_clear)),
        ...
        Row(
            ...
            OutlinedButton(
                ...
                CosmosText(
                    stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_analysis_filter_reset)),
                    style = CosmosAppTheme.typography.labelLarge,
                )
            }
            Button(
                ...
                CosmosText(
                    stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_analysis_filter_apply)),
                    style = CosmosAppTheme.typography.labelLarge,
                )
            }
        }
