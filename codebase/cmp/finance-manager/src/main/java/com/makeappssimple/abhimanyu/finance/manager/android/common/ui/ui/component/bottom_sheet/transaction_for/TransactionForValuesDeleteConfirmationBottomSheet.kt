...
internal fun TransactionForValuesDeleteConfirmationBottomSheet(
    ...
    MyConfirmationBottomSheet(
        data = MyConfirmationBottomSheetData(
            messageStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_transaction_for_values_menu_message)),
            negativeButtonTextStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_transaction_for_values_menu_negative_button_text)),
            positiveButtonTextStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_transaction_for_values_menu_positive_button_text)),
            titleStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_bottom_sheet_transaction_for_values_menu_delete_title)),
        ),
        handleEvent = { event ->
            when (event) {
