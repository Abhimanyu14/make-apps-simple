...
package com.makeappssimple.abhimanyu.finance.manager.android.common.ui.feature.accounts.edit_account.screen
        ...
        Column(
            ...
            if (uiState.visibilityData.balanceAmountTextField) {
                MyOutlinedTextFieldV2(
                    ...
                    data = MyOutlinedTextFieldDataV2(
                        ...
                        labelStringResource = CosmosStringResource.Text(FinanceManagerStrings.finance_manager_screen_add_or_edit_account_balance_amount_value),
                        trailingIconContentDescriptionStringResource = CosmosStringResource.Text(FinanceManagerStrings.finance_manager_screen_add_or_edit_account_clear_balance_amount_value),
            ...
            CosmosSaveButton(
                ...
                data = CosmosSaveButtonData(
                    ...
                    isLoading = uiState.isLoading,
                    stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_edit_account_floating_action_button_content_description)),
                ),
                handleEvent = { event ->
                    when (event) {
