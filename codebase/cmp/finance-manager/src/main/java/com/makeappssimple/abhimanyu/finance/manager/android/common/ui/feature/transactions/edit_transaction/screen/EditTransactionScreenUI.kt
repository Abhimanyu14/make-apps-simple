...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.MyOutlinedTextField
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.MyOutlinedTextFieldData
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.MyOutlinedTextFieldEvent
        ...
        Column(
            ...
            CosmosSaveButton(
                ...
                data = CosmosSaveButtonData(
                    ...
                    isLoading = uiState.isLoading,
                    stringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_edit_transaction_floating_action_button_content_description)),
                ),
                handleEvent = { event ->
                    when (event) {
