...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.action_button.CosmosActionButton
import com.makeappssimple.abhimanyu.cosmos.design.system.components.action_button.CosmosActionButtonData
import com.makeappssimple.abhimanyu.cosmos.design.system.components.action_button.CosmosActionButtonEvent
...
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.search_bar.CosmosSearchBarDataV2
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.search_bar.CosmosSearchBarEventV2
import com.makeappssimple.abhimanyu.cosmos.design.system.components.text_field.search_bar.CosmosSearchBarV2
...
internal fun TransactionsScreenUI(
    ...
    val duplicateTransactionSuccessfulSnackbarText = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_transactions_duplicate_transaction_successful)).text
        ...
        topBar = {
            if (uiState.isInSelectionMode) {
                MySelectionModeTopAppBar(
                    appBarActions = {
                        CosmosIconButton(
                            onClickLabelStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_transactions_selection_mode_appbar_menu_more_options)),
                            onClick = {
        ...
        floatingActionButton = {
            AnimatedVisibility(
                ...
                CosmosCircularFloatingActionButton(
                    ...
                    contentDescriptionStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_transactions_floating_action_button_content_description)),
                    onClick = {
            ...
            Box(
                ...
                CosmosSearchBarV2(
                    data = CosmosSearchBarDataV2(
                        ...
                        placeholderStringResource = CosmosStringResource.Text(value = FinanceManagerStrings.get(template = FinanceManagerStrings.finance_manager_screen_transactions_searchbar_placeholder)),
